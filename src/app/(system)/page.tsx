        ...
        <>
            ...
            <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a href="#" className="text-slate-400 hover:text-white transition-colors">Certificados</a>
                    <a href="#" className="text-slate-400 hover:text-white transition-colors">Templates</a>
                    <a href="#" className="text-slate-400 hover:text-white transition-colors">Dados</a>
                    <a href="#" className="text-slate-400 hover:text-white transition-colors">E-mails</a>
                    <a href="#" className="text-slate-400 hover:text-white transition-colors">Configurações</a>
                </div>

                <div className="flex items-center gap-4">
                    <div className="hidden md:flex items-center gap-3">
                        <span className="text-slate-400 text-sm">João Silva</span>
