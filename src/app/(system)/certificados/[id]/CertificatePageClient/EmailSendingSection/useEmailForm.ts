...
export const emailFormSchema = z.object({
    subject: z
        ...
        .max(255, 'Máximo de 255 caracteres ultrapassado'),
    body: z
        .string({ error: 'O corpo do e-mail é obrigatório' })
        .min(1, 'O corpo do e-mail é obrigatório')
        .max(800, 'Máximo de 800 caracteres ultrapassado'),
    emailColumn: z
        .string({ error: 'A coluna de e-mail é obrigatória' })
        .min(1, 'Selecione a coluna de e-mail')
        .max(100),
