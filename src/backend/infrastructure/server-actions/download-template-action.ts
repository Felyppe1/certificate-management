...
const downloadTemplateActionSchema = z.object({
...
export async function downloadTemplateAction(_: unknown, formData: FormData) {
    ...
    try {
        ...
        const parsedData = downloadTemplateActionSchema.parse(rawData)
        ...
        return {
            success: false,
            message: 'Ocorreu um erro ao tentar baixar o template',
        }
    }
}
